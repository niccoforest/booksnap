      ...
      <div className={styles.content}>
        ...
        {entry && (
          <div className={styles.reactionsSection}>
            ...
            >
              <svg viewBox="0 0 24 24" width="18" height="18" fill={entry.liked ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
              </svg>
              {entry.liked ? 'Piaciuto' : 'Mi piace'}
            </button>
            <button
            ...
            >
              <svg viewBox="0 0 24 24" width="18" height="18" fill={entry.favorite ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
              </svg>
              {entry.favorite ? 'Nei preferiti' : 'Aggiungi ai preferiti'}
            </button>
          </div>
        )}
